...
The Anthropic Economic Index ReportWorldwide, uneven adoption remains well-explained by GDP per capita.
...
The Anthropic Economic Index Reporthalf (50%) of all usage despite representing only 38% of the working-age
...
The Anthropic Economic Index Reportusing Claude to automate routine back-office workflows such as email
...
The Anthropic Economic Index Reporttasks (“task iteration”) rather than asking Claude to explain concepts
...
The Anthropic Economic Index ReportPersistent regional concentration
...
The Anthropic Economic Index ReportFigure 1.6: AUI concentration around the world and within the US in this and the prior report
...
The Anthropic Economic Index ReportFigure 1.7: AUI and share of workers in Computer & Mathematical occupations in each US State
...
The Anthropic Economic Index ReportSigns of faster Claude diffusion in the US among low
usage states
...
The Anthropic Economic Index ReportFigure 1.8: Anthropic AI Usage Index (AUI) across the US, August 2025 (V3) and November 2025 (V4)
...
The Anthropic Economic Index Reportpredictor of Claude usage (relevance) but being measured independently,
...
The Anthropic Economic Index Report4  With our bottom-up analysis of 1P API traffic we see Claude used to “Generate
...
The Anthropic Economic Index ReportCHAPTER 2
...
The Anthropic Economic Index ReportTask complexity captures that tasks can vary in their complexity, including
...
The Anthropic Economic Index Reportdeliberation within our economic research team. Our main selection criteria
...
The Anthropic Economic Index ReportThe primitives’ value is in what they can predict
...
The Anthropic Economic Index ReportFigure 2.1: Education years needed to understand the human prompt and share of workers with at least a Bachelor’s Degree.
...
The Anthropic Economic Index ReportPrimitives highlight how use cases differ
...
The Anthropic Economic Index ReportUse case. Claude classifies 64% of software development requests as work-
...
The Anthropic Economic Index Reportmore autonomy on average, and are more likely to bring tasks they couldn’t
...
The Anthropic Economic Index ReportCHAPTER 3
...
The Anthropic Economic Index ReportClaude is mostly used for work, but use cases diversify
with adoption
...
The Anthropic Economic Index ReportFigure 3.2: Per capita income predicts how Claude is used across countries.
...
The Anthropic Economic Index Reportreport that GDP is strongly correlated with the AUI (see Figures 3.3 and 3.4).
...
The Anthropic Economic Index ReportFigure 3.4: Relationship between the Anthropic AI Usage Index and five core economic primitives and GDP per capita at the US
state level.
Each plot shows the bivariate relationship between the natural logarithm of the Anthropic AI Usage Index and a core economic
...
The Anthropic Economic Index Reportprimitives—suggesting education may be capturing variation that’s better
...
The Anthropic Economic Index ReportFigure 3.5: Relationship between task success and human education.
...
The Anthropic Economic Index Reportthe importance of model design and training. While Claude is able to respond
...
The Anthropic Economic Index Reportpatterns do not hold. Task success and human education show opposite
...
The Anthropic Economic Index Report3 The world map is based on Natural Earth’s world map with the ISO standard
...
The Anthropic Economic Index ReportCHAPTER 4
...
The Anthropic Economic Index Reportof schooling (a college degree) attain a 12x speedup. This implies that
...
The Anthropic Economic Index Reportthe automation share is essentially unrelated to the human levels of education
...
The Anthropic Economic Index ReportTask Horizons in Real-World Usage
...
The Anthropic Economic Index Reportcrosses the horizontal 50% success line at 3.5 hours, suggesting that API calls
...
The Anthropic Economic Index ReportRevisiting occupation penetration with effective
AI coverage
...
The Anthropic Economic Index ReportFigure 4.4: Effective AI coverage vs. Task coverage
...
The Anthropic Economic Index Reportpreparing interpretive reports—have high success rates. These occupations
...
The Anthropic Economic Index Reportidentify laws and court decisions relevant to pending cases” is predicted to
...
The Anthropic Economic Index Reportexperimental activities” (13.5 years). Travel agents also experience deskilling
...
The Anthropic Economic Index ReportRevisiting the aggregate productivity implications of
Claude usage
...
The Anthropic Economic Index Reportlesson plans more efficiently with AI while having no impact on time spent
...
The Anthropic Economic Index ReportFigure 4.6 Implied labor productivity effect from AI as a function of within-occupation task substitutability
...
The Anthropic Economic Index Report2.2–2.6 percentage points per year, consistent with greater specialization in
...
The Anthropic Economic Index ReportThe counterpart to these transformative labor market effects is the broader
...
The Anthropic Economic Index Report1M sample and assume that efficiency gains for any task in our sample, even
...
The Anthropic Economic Index ReportConcluding Remarks
...
The Anthropic Economic Index ReportHow willing users are to experiment with AI, and whether policymakers create
